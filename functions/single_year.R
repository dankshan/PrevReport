# prevTable <- function(df, variable_table, groups_table, filterGroup = NULL, filterVal = NULL, rounding = 2, subheading = TRUE, password){
# 
#   if(password == "@$@#%Youth") {
# 
#   filterGroup <- enquo(filterGroup)
# 
# 
#     singlePrev <- function(df, variable, value, varname, group, filterGroup = NULL, filterVal = NULL, rnd){
# 
#       var <- enquo(variable)
#       val <- enquo(value)
#       grp <- enquo(group)
...
# 
#       temptable <- tibble(groupType = NA_character_,
#                           group = NA_character_)
# 
...
# 
#     outdf %>%
#       gt(groupname_col = "groupType", rowname_col = "group") %>%
